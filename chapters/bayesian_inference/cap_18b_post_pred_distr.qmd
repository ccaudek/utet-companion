...
Nel manuale didattico abbiamo esaminato due aspetti fondamentali dell’inferenza bayesiana: (1) come costruire le distribuzioni a posteriori dei parametri di interesse e (2) come verificare i *prior* con i controlli predittivi, per assicurarci che le nostre assunzioni iniziali siano compatibili con la realtà psicologica che vogliamo studiare.

Ora compiamo un passo ulteriore. Non ci chiediamo più soltanto se i *prior* siano ragionevoli, ma se *l’intero modello*, dopo aver incorporato i dati osservati, è capace di generare previsioni plausibili per nuovi individui, nuove sedute o nuove prove. Questo ci porta al concetto di *distribuzione predittiva a posteriori*.

Se un modello rappresenta in modo credibile il processo che ha generato i dati, allora deve saper fare due cose: adattarsi ai dati raccolti *e* simulare dati nuovi con caratteristiche simili. In psicologia, questo significa ad esempio prevedere il punteggio a un questionario d’ansia per uno studente che non ha partecipato allo studio, stimare la probabilità di ricordo corretto in una prova di memoria per un nuovo partecipante, oppure quantificare la riduzione attesa dei sintomi depressivi dopo un ciclo di terapia cognitivo-comportamentale.

Spesso la distribuzione predittiva a posteriori è persino più interessante della sola distribuzione a posteriori dei parametri. Mentre quest'ultima quantifica la nostra incertezza riguardo a quantità latenti - come la media dei punteggi BDI in una popolazione - la distribuzione predittiva a posteriori risponde a domande sostantivamente più informative sul piano applicativo: qual è la probabilità che un nuovo paziente raggiunga una remissione clinicamente significativa? Quale gamma di punteggi possiamo attenderci nella prossima somministrazione del test Stroop?

In termini concettuali, distinguiamo tra due livelli di incertezza. La distribuzione a posteriori dei parametri cattura esclusivamente l'incertezza epistemica riguardo alle quantità latenti del modello. La distribuzione predittiva a posteriori, invece, integra questa componente con l'incertezza intrinseca al processo di campionamento stesso, offrendo così una rappresentazione completa di ciò che potremmo realisticamente osservare in future misurazioni.

In questo approfondimento, esamineremo in dettaglio come costruire la distribuzione predittiva a posteriori, come interpretarla e come utilizzarla per mettere alla prova il modello in modo concreto.
