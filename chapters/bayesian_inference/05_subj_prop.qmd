...
Nei capitoli precedenti abbiamo riflettuto sul ruolo centrale dell’incertezza nella ricerca psicologica e abbiamo visto come l’approccio bayesiano offra un linguaggio naturale e potente per rappresentarla. Abbiamo anche distinto tra modelli fenomenologici, che descrivono semplicemente le relazioni tra variabili, e modelli meccanicistici, che invece cercano di formalizzare i processi psicologici sottostanti. In questo capitolo ci concentreremo su un caso di studio tra i più diffusi e istruttivi: l’inferenza sulla proporzione di successi in un compito sperimentale o in un campione di soggetti.
...
Ecco una versione rivista, più scorrevole e coerente con lo stile dei capitoli precedenti. Ho reso il testo più compatto, ma mantenendo tutte le spiegazioni didattiche:
