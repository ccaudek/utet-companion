...
Come illustrato nel manuale didattico principale, in psicologia operiamo spesso in condizioni che rendono complessa l'inferenza statistica: campioni di piccole dimensioni, misure soggette a rumore e effetti reali ma di lieve entità. In questo contesto metodologicamente impegnativo, l'approccio bayesiano offre un vantaggio sostanziale, in quanto rende esplicito il modo in cui le nostre conoscenze pregresse, codificate nella distribuzione a priori, si integrano con l'evidenza empirica emergente dai dati. Non si tratta di una "correzione" arbitraria dei risultati, ma di una stabilizzazione dell'inferenza in condizioni di informazione limitata che riduce le sovrastime tipiche degli studi su piccoli campioni (il cosiddetto "winner's curse") e gli errori di tipo M, ovvero la tendenza sistematica a stimare effetti più ampi di quanto siano nella realtà.[^M]
