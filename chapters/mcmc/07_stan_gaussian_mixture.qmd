# Modelli di mistura gaussiani {#sec-mcmc-mixture-models}

::: {.callout-note appearance="minimal"}

Questo capitolo costituisce un approfondimento specialistico che non trova spazio nel manuale didattico principale, ma che affronta una classe di modelli particolarmente rilevante per l'analisi di popolazioni eterogenee in psicologia. I modelli di mistura rappresentano uno strumento essenziale quando i dati osservati derivano da processi generativi multipli o quando la popolazione in esame comprende sottogruppi distinti con caratteristiche distinte.
:::
...
## Una rappresentazione flessibile
...
L’idea fondamentale dei modelli di mistura gaussiana consiste nel fornire una rappresentazione flessibile di situazioni in cui i dati osservati originano da molteplici processi generativi sottostanti. Questo approccio risulta particolarmente rilevante in psicologia, dove i campioni di studio spesso includono soggetti appartenenti a sottogruppi distinti, non sempre identificabili a priori. L’utilizzo di modelli di mistura consente di individuare tali sottopopolazioni latenti e di caratterizzarne le proprietà in modo più accurato, aprendo la strada a interpretazioni più articolate e sostantive dei fenomeni psicologici.

In questo materiale di approfondimento, il modello di mistura gaussiana verrà impiegato nel @sec-corpora-informative-priors come strumento per identificare le caratteristiche della distribuzione a priori a partire dalle evidenze disponibili in letteratura.
