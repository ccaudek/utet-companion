...
Questo capitolo costituisce un approfondimento specialistico che non trova spazio nel manuale didattico principale, dedicato a una classe di modelli statistici di particolare rilevanza per la ricerca psicologica contemporanea. L'analisi di fenomeni complessi richiede spesso l'impiego di modelli multivariati in cui coesistono parametri di interesse diretto e parametri accessori, la cui corretta gestione è essenziale per inferenze valide.

In molte situazioni statistiche ci si trova di fronte a modelli che includono più parametri incogniti. Tuttavia, non tutti questi parametri hanno lo stesso rilievo interpretativo: spesso, infatti, l'interesse dell'analisi si concentra su uno o pochi di essi, mentre gli altri, pur essendo indispensabili per una corretta descrizione dei dati, vengono considerati secondari. Questi ultimi prendono il nome di *parametri di disturbo* (*nuisance parameters*).

La gestione dei parametri di disturbo rappresenta una sfida metodologica cruciale in psicologia, dove i fenomeni studiati sono tipicamente influenzati da molti fattori concomitanti. Ad esempio, nello studio dell'efficacia di un intervento terapeutico, l'effetto del trattamento rappresenta il parametro di interesse primario, mentre le caratteristiche individuali dei partecipanti, sebbene influenzino i risultati, costituiscono spesso dei parametri di disturbo. La capacità di isolare l'effetto d'interesse da queste fonti di variabilità contestuale è essenziale per la validità della ricerca psicologica.

L'obiettivo di un'analisi bayesiana è solitamente quello di ottenere la distribuzione marginale a posteriori dei parametri di interesse. Per farlo, esistono due strategie. La prima consiste nel calcolare la distribuzione congiunta a posteriori di tutti i parametri e successivamente integrare, in modo analitico o numerico, rispetto a quelli di disturbo. Si tratta di un metodo formalmente corretto, ma che spesso risulta difficile da applicare: nei modelli realistici, l'integrazione può diventare estremamente complessa.

La seconda strategia, oggi la più diffusa, sfrutta le tecniche di simulazione. Attraverso il campionamento MCMC è possibile generare campioni dalla distribuzione congiunta a posteriori e, in fase di analisi, concentrarsi solo sui parametri di interesse, ignorando i campioni relativi a quelli di disturbo. Questo approccio presenta il vantaggio di poter essere applicato facilmente anche a modelli complessi, nei quali l'integrazione analitica risulterebbe impraticabile.

In questo capitolo, prenderemo in esame un esempio concreto che illustra il ruolo dei parametri di interesse e di quelli di disturbo. Immaginiamo uno studio che valuti l'efficacia di un intervento cognitivo, come un programma di allenamento per la memoria di lavoro. Il nostro obiettivo sarà stimare la differenza nei punteggi medi di un test tra il gruppo che ha ricevuto l'intervento e il gruppo di controllo. Le capacità cognitive di base dei partecipanti, pur influenzando i punteggi, non sono l'oggetto centrale dell'indagine, pertanto saranno trattate come parametri di disturbo. Attraverso la marginalizzazione, sarà possibile concentrarsi sull'effetto dell'intervento, mantenendo al contempo la complessità necessaria per una descrizione realistica dei dati.
