...
y = b x.
$$
Questa espressione rappresenta una *proporzionalità diretta* tra $x$ e $y:$ al crescere di $x$, $y$ varia in proporzione. 
...
::: {#fig-linear-fun}
![](../../figures/linear_function.png){width="70%"}
