...
```{r}
#| label: fig-posterior-predictive-density-overlay
#| fig-cap: "Sovrapposizione tra la densità dei dati osservati e le densità di cinquanta repliche generate dalla distribuzione predittiva a posteriori. Una buona sovrapposizione indica che il modello riproduce adeguatamente posizione, dispersione e forma della distribuzione osservata."
#| fig-alt: "Una curva scura rappresenta la densità dei dati osservati, mentre cinquanta curve più chiare rappresentano altrettante repliche predittive a posteriori. Le curve simulate formano una nube attorno alla distribuzione osservata."
#| fig-width: 7
#| fig-height: 5
...
```{r}
#| label: fig-posterior-predictive-stat-mean
#| fig-cap: "Controllo predittivo a posteriori della media. La distribuzione mostra le medie calcolate sulle repliche generate dal modello; la linea verticale indica la media dei dati osservati."
#| fig-alt: "Distribuzione delle medie ottenute dalle repliche predittive a posteriori, con una linea verticale che segnala la media osservata e permette di valutarne la compatibilità con il modello."
#| fig-width: 6
#| fig-height: 4
...
```{r}
#| label: fig-posterior-predictive-stat-sd
#| fig-cap: "Controllo predittivo a posteriori della deviazione standard. La distribuzione delle deviazioni standard delle repliche viene confrontata con il valore calcolato sui dati osservati."
#| fig-alt: "Distribuzione delle deviazioni standard ottenute dalle repliche predittive a posteriori, con una linea verticale che indica la deviazione standard dei dati osservati."
#| fig-width: 6
#| fig-height: 4
...
```{r}
#| label: fig-posterior-predictive-stat-q95
#| fig-cap: "Controllo predittivo a posteriori del 95° percentile. La distribuzione dei quantili estremi calcolati sulle repliche consente di verificare se il modello riproduce adeguatamente la coda superiore dei dati osservati."
#| fig-alt: "Distribuzione dei novantacinquesimi percentili ottenuti dalle repliche predittive a posteriori, con una linea verticale che indica il corrispondente percentile dei dati osservati."
#| fig-width: 6
#| fig-height: 4
...
```{r}
#| label: fig-posterior-predictive-intervals
#| fig-cap: "Intervalli predittivi a posteriori per un sottoinsieme di trenta osservazioni. I punti rappresentano i valori osservati, mentre le bande mostrano gli intervalli predittivi centrali al 50% e al 90%."
#| fig-alt: "Trenta osservazioni rappresentate da punti sono confrontate con intervalli predittivi interni al cinquanta per cento ed esterni al novanta per cento. La posizione dei punti rispetto alle bande mostra la copertura del modello."
#| fig-width: 8
#| fig-height: 5
...
```{r}
#| label: fig-posterior-predictive-histograms
#| fig-cap: "Confronto tra l'istogramma dei dati osservati e quelli di otto repliche predittive a posteriori. Somiglianze nella forma, nella posizione e nella dispersione indicano un adattamento plausibile del modello."
#| fig-alt: "Una griglia di istogrammi confronta la distribuzione dei dati osservati con otto insiemi di dati simulati dalla distribuzione predittiva a posteriori."
#| fig-width: 8
#| fig-height: 6
...
```{r}
#| label: fig-posterior-predictive-density-sigma-estimated
#| fig-cap: "Sovrapposizione delle densità per il modello normale in cui anche la deviazione standard è stimata. La densità osservata viene confrontata con cinquanta repliche predittive a posteriori, incorporando l'incertezza sia sulla media sia sulla dispersione."
#| fig-alt: "Una curva scura per la densità osservata è sovrapposta a cinquanta curve più chiare generate da un modello normale che stima sia la media sia la deviazione standard."
#| fig-width: 7
#| fig-height: 5
