...
Definiamo quindi l’*Expected Log Predictive Density (ELPD):*
$$
\mathrm{ELPD} = \mathbb{E}_{p(\tilde y)}\!\left[\log q(\tilde y \mid y)\right].
$$
Questa quantità rappresenta il valore *atteso* del log-score che il modello assegna a una nuova osservazione $\tilde{y}$ generata da $p$.

**Regola fondamentale:** *massimizzare l’ELPD equivale a ridurre al minimo la distanza informazionale dalla verità.*

### Giustificazione teorica {.unnumbered .unlisted}
...
$$
dove $q(y_i \mid y_{-i})$ è la densità predittiva per $y_i$ quando il modello è addestrato su *tutti i dati tranne $y_i$*.
...
::: {.callout-tip title="Efficienza computazionale: PSIS-LOO"}
...
#### Interpretazione e confronto dell’ELPD

::: {.callout-tip title="Interpretazione e confronto"}
#### Come interpretare l'ELPD {.unnumbered .unlisted}
...
::: {.callout-note collapse=true title="Esempio: Confronto tra due modelli"}
...
::: {.callout-note collapse=true title="Esempio con la convenzione della Devianza (Stan)"}
...
### La distribuzione predittiva posteriore {#sec-predittiva}
...
#### Comprendere l’integrale predittivo
...
#### Dilemma teorico: fitting vs generalizzazione
...
#### La divergenza KL come misura di distanza
...
#### L’ostacolo pratico e la motivazione dell’ELPD
...
#### Esempio intuitivo: la moneta truccata
...
## Dal log-score alla LPPD: accuratezza in-sample {#sec-logscore-lppd}
...
#### La domanda di base: quanto il modello scommette bene?
...
#### Definizione formale del log-score
...
#### Interpretazione: probabilità e fiducia del modello
...
#### Parametri fissi vs incerti: due filosofie
...
#### La LPPD come accuratezza in-sample
...
#### Limiti della LPPD e rischio overfitting
...
## Dalla LPPD all’ELPD: valutazione out-of-sample {#sec-lppd-elpd}
...
## L’ELPD e la divergenza di Kullback–Leibler {#sec-elpd-kl}
...
## Dalla teoria alla pratica: LOO-CV e PSIS-LOO {#sec-loo-psis}
...
#### L’approssimazione PSIS-LOO e le diagnostiche
...
#### Sintesi dei criteri predittivi
...
#### Tipi di criteri e formule principali
...
#### Quando usare AIC, BIC, WAIC o LOO
...
#### Penalizzazione effettiva e complessità reale
...
### Procedura passo-passo {#sec-procedura}
