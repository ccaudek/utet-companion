...
Il caso più semplice è il *modello di regressione lineare bivariato*, che descrive la relazione tra due variabili. L’idea di base è che, se $X$ e $Y$ sono associate, possiamo approssimare la loro relazione con una *retta* che indica come $Y$ tende a variare al variare di $X$[^funlin].
