...
Nei capitoli precedenti abbiamo visto che, nell’ottica frequentista, la regressione lineare bivariata consente di stimare la relazione tra due variabili attraverso il metodo dei minimi quadrati. Questo approccio, pur essendo efficace, presenta dei limiti evidenti: si basa su test d'ipotesi e valori-$p$, non permette di integrare la conoscenza pregressa e fornisce solo una descrizione indiretta dell'incertezza sui parametri.

L’approccio bayesiano alla regressione propone una prospettiva diversa. L’idea centrale è la stessa che abbiamo incontrato in tutti i modelli precedenti: si combinano informazioni a priori con i dati osservati per ottenere una distribuzione a posteriori. In questo caso, i parametri della retta di regressione (intercetta, pendenza e varianza residua) non sono considerati come valori fissi, ma come quantità aleatorie descritte da una distribuzione di probabilità.
...
In questo capitolo vedremo come specificare e stimare un modello bayesiano di regressione lineare bivariata a partire da ipotesi semplici e confronteremo i risultati ottenuti con quelli dell'approccio frequentista. Ciò ci darà l'opportunità di evidenziare i punti di forza del quadro bayesiano e di comprendere meglio come interpretare i coefficienti di regressione in termini probabilistici.
