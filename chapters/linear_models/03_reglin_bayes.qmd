...
Nei capitoli precedenti abbiamo appreso come, nella prospettiva frequentista, la regressione lineare bivariata stimi la relazione tra due variabili ricorrendo al metodo dei minimi quadrati. Sebbene robusto, questo paradigma mostra dei limiti intrinseci: poggia su test d'ipotesi e valori-p, non consente di incorporare conoscenze pregresse e fornisce una caratterizzazione solo indiretta dell'incertezza parametrica.

L'approccio bayesiano alla regressione introduce una prospettiva alternativa, coerentemente con il quadro concettuale già esplorato nei modelli precedenti. Il principio cardine rimane la combinazione di informazioni a priori con i dati osservati per derivare una distribuzione a posteriori. In questo contesto, i parametri del modello di regressione—intercetta, pendenza e varianza dell'errore—non sono trattati come quantità fisse, bensì come variabili aleatorie, ciascuna caratterizzata da una propria distribuzione di probabilità.

Tale impostazione consente di:

- dichiarare esplicitamente le aspettative iniziali riguardo ai parametri, formalizzandole attraverso distribuzioni a priori;
- aggiornare coerentemente tali aspettative sulla base dell'evidenza empirica;
- quantificare l'incertezza rimanente servendosi delle distribuzioni a posteriori complete, superando la logica dicotomica dei test e l'interpretazione indiretta degli intervalli di confidenza.

In questo capitolo, illustreremo come specificare e stimare un modello bayesiano di regressione lineare bivariata a partire da ipotesi iniziali semplici, mettendo a confronto i risultati con l'approccio frequentista. Questo confronto ci permetterà di apprezzare i vantaggi del quadro bayesiano e di approfondire l'interpretazione probabilistica dei coefficienti di regressione.
:::
