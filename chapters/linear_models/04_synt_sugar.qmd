...
Nel @sec-linmod-bayesian-reg abbiamo visto come formulare e stimare un modello bayesiano di regressione lineare bivariata utilizzando distribuzioni a priori semplici. Questo esercizio ci ha permesso di comprendere l'essenza dell'approccio: i parametri della retta di regressione non sono valori fissi, ma quantità descritte da distribuzioni di probabilità che vengono aggiornate in base ai dati.
...
In questo capitolo presenteremo quello che potremmo chiamare "zucchero sintattico": strumenti che rendono la specificazione dei modelli in R più compatta e leggibile, pur mantenendo intatta la logica bayesiana sottostante. Questo passaggio intermedio ci sarà utile per concentrarci sugli aspetti concettuali della modellazione, senza doverci preoccupare di dettagli tecnici ripetitivi. Nei capitoli successivi, quando introdurremo Stan, vedremo come questa esigenza di sintesi e chiarezza diventi ancora più cruciale.
:::
