...
La ricerca psicologica si confronta costantemente con una sfida epistemologica e metodologica fondamentale: i costrutti d'interesse, quali l'ansia, l'intelligenza o la motivazione, sono entità latenti, non direttamente osservabili. La loro misurazione richiede pertanto approssimazioni operative, quali questionari, test psicometrici e scale di valutazione, che incorporano inevitabilmente una componente di errore.

Trascurare la limitata affidabilità psicometrica di tali strumenti non costituisce un mero dettaglio tecnico, bensì un problema metodologico sostanziale, in grado di alterare sistematicamente la validità delle inferenze scientifiche. Un esempio paradigmatico è il fenomeno dell'*attenuazione* della stima: quando una variabile predittiva continua affetta da errore di misura viene trattata in un'analisi di regressione come se fosse misurata perfettamente, il coefficiente di regressione stimato risulta  distorto verso lo zero. Questa distorsione statistica, nota come *attenuazione del coefficiente di regressione*, sottostima artificialmente l'entità della relazione tra il costrutto latente e l'esito di interesse, compromettendo l'accuratezza delle conclusioni.

Il presente capitolo illustra come un approccio bayesiano possa offrire una soluzione operativa a tale problematica. Modellizzando esplicitamente il processo di misurazione, è possibile correggere queste distorsioni e ottenere stime più veritiere delle relazioni tra costrutti latenti. In pratica, ciò consente di condurre l'analisi statistica sul piano del *tratto latente* effettivamente rilevante, propagando in modo coerente l'incertezza derivante dalla sua misurazione.
:::
